...
export default async function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section style={{ display:'grid', gridTemplateColumns:'1fr 1fr', minHeight:380, overflow:'hidden' }}>
        <div style={{ padding:'56px 48px', background:'#2d5016', display:'flex', flexDirection:'column', justifyContent:'center' }}>
          ...
          <h1 style={{ fontFamily:'Playfair Display,serif', fontSize:42, fontWeight:700, color:'#fff', lineHeight:1.15, margin:'0 0 18px' }}>
        ...
        <div style={{ background:'#e8f0df', display:'flex', alignItems:'center', justifyContent:'center', padding:40, position:'relative' }}>
      ...
      {/* Trust bar */}
      <div style={{ display:'flex', justifyContent:'center', background:'#fff', borderBottom:'1px solid rgba(0,0,0,0.06)' }}>
        {trustItems.map((t, i) => (
          <div key={t} style={{
      ...
      {/* Featured Products */}
      <section style={{ padding:'28px 28px 40px' }}>
      ...
      {/* Story */}
      <section id="story" style={{ background:'#f5ede3', padding:'52px 28px', display:'grid', gridTemplateColumns:'1fr 1fr', gap:40, alignItems:'center' }}>
        <div>
